...
session_start();
$status="";
//kul mara array by run b select key value mel array that stores in local value
...
if (isset($_POST['action']) && $_POST['action']=="change"){
  foreach($_SESSION["shopping_cart"] as &$value){// pass value by reference and not by value so ay update in the cart they will update once the call is made
    if($value['ID'] === $_POST["ID"]){
